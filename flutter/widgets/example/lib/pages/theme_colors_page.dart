...
class MechanixThemeColorsPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ListenableBuilder(
      ...
      builder: (context, _) {
        ...
        final mechanixThemeMode = ThemeToggle.instance.themeMode;
                ...
                children: [
                  VariantPicker(
                    ...
                    onVariantChanged: (variant) =>
                        ThemeToggle.instance.setThemeVariant(variant),
                  ),
                  Row(
